...
class RoleHelper {
    public static $actions = [
        ...
        'orders' => [
            ...
            'actions' => [
                'list' => 'Просмотр списка заказов',
                'single' => 'Просмотр информации об одном заказе',
        ...
        'compositions' => [
            'description' => 'Управление составом товаров',
            'actions' => [
                'list' => 'Просмотр списка составов',
                'create' => 'Добавление состава',
                'edit' => 'Редактирование состава'
            ]
        ],
        'seasons' => [
